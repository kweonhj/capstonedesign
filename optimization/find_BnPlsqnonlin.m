...
[optVariables, ~, residuals] = lsqnonlin(@(variables) objectiveFunction(variables, B, Positions), initialGuess, lb, ub, options);
...
% Calculate R-squared
SSres = sum(residuals.^2);  % Sum of squares of residuals
