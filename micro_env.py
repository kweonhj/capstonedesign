...
# -*- coding: utf-8 -*-
"""
Created on Fri May  5 10:15:01 2023
...
class Microrobot_Env:
    ...
    def reset_arduino(self):
        ...
        try:
            current = np.zeros(4,1)
            m_control = mot_con.motordrive(current,self.ard1)
            m_control.Mcurrent()
        except:
    ...
    def record_logs(self, M_x, M_y, freq, phi_x, phi_y, step_theta_dot):
    ...
    def step(self, action):
        ...
        try:
            ...
            PWMy = M_x*sin(freq*t/1000+phi_y)*400
            I = [PWMx, PWMy]
            m_control = mot_con.motordrive(I,self.ard1)
            m_control.Mcurrent()
        ...
        self.record_logs(M_x, M_y, freq, phi_x, phi_y, step_theta_dot)
